...
At the same time though, it is important for Players to recognise that Rulers is a group game. There are other Players and the N.O. needs to give time to all of them. Roleplaying out a lost cause may take away precious time from other Players who stand a chance of actually winning their battles. Ultimately, the N.O. has the final say. Automatic combat is a way to speed up the game, not a system to be abused.[^36]
...
| 4–6 | Lands in front of the target |
| 7–8 | Lands directly on top of the target (without damaging it) |
| 9–10 | Goes high into the air and lands somewhere on the battlefield. Roll to hit any random Troop on the Battlefield (N.O.'s discretion). |

A Siege Weapon does damage to Troops equal to the successes it rolled +2.

Most Siege Weapons can only target Fortifications, however the N.O. may decide if it is possible to target specific Troops with them if it adds to the narrative of the Siege. For instance, a Trebuchet takes one Action to load and another to fire. It cannot be moved once deployed on the battlefield and its shot flies in a high arc. As a result, it cannot target a moving Troop and hope to hit it with any accuracy. However, if the Army it is facing is particularly large, the N.O. may rule that it can be used to hit in the general area of the advancing forces.

Beyond that, the Players and the N.O. are free to describe the battle and how the attacking Troops try to storm the Settlement. The Defender should have a rough layout[^37] of the defences of their Settlement (approved by the N.O.).
