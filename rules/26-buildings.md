...
Every Building also takes time to Build. During construction the Building does not provide its benefit, as it is still being built. It also costs slightly more per turn, as building is more intensive than maintenance. Once the number of turns needed for construction has passed, the Building provides its benefit.

| | Tiny | Small | Medium | Large | Colossal |
|---|---|---|---|---|---|
| Build Time | 1 Season | 2 Seasons | 3 Seasons | 4 Seasons | 6 Seasons |
...
While not as formidable as a Castle, the Wooden walls of this Motte & Bailey Fort can still withstand and repel any would-be attackers. If built in a Settlement, this Fortification takes up one building slot. Otherwise, it can be built as a free-standing structure, anywhere that it is reasonable for it to be constructed in the Realm. It comes with Wooden Walls, a Wooden Gatehouse and a Wooden Keep.

#### Gatehouse
**Size:** Small | **Can be built outside a Settlement:** No | **Takes up a Building Slot:** No | **Requirements:** Timber or Stone Resource

These fortified gateways come with a vaulted entrance, overlooks and firing slits for defenders. Depending on the material the Gatehouse is made from determines its defensive strength against attempts to destroy it. However, the gate itself is a weak point that can be targeted by attacking Troops.

| Gatehouse Component | Defence Rating |
|---|---|
| Gate | 2 |
| Gatehouse Gate | 3 |
| Portcullis | 6 |

A Stone Gatehouse also comes with an iron portcullis that can be lowered for added defence of the Gate.

#### Walls
**Size:** Small / Medium / Large | **Can be built outside a Settlement:** Yes | **Takes up a Building Slot:** No | **Requirements:** Timber or Stone Resource
...
A Wall could also be built outside a Settlement, but this is at the N.O.'s discretion. Depending on where the wall is being constructed and the difficulty of the terrain, the N.O. may decide whether a Wall could be built and what size it would be.

Depending on what material is used will determine the defensive strength of the wall (refer to the Fortification table). Walls also have a parapet for Troops to stand on and walk along. All Ranged Troops standing on Walls can shoot further than they would normally be able to. Walls also come with stairways to access them and gates to allow access through them, but these are not as robust as a fortified Gatehouse.

#### Watchtower
**Size:** Small | **Can be built outside a Settlement:** Yes | **Takes up a Building Slot:** No | **Requirements:** Timber or Stone Resource

This Watchtower allows the Troops Garrisoned inside to have an excellent view of their surroundings, as well as a means of signalling to Settlements and other Watchtowers. The Watchtower features a stairway to an observation deck with a vaulted roof and a firepit. If it's made of Stone, it has sturdy walls and a hefty door.

If built inside a Settlement, a Watchtower does not take up a Building slot. A Watchtower can also be built outside a Settlement if the terrain is capable of supporting it. Watchtowers can signal to each other and Settlements with beacons. How far the signal can be seen from is up for the N.O. to decide — take into account the climate, terrain and likely line of sight.
