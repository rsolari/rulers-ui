...
Political Actions are defined by the action word they use. Examples include "Investigate", "Send", "Negotiate" or "Hold". They can be used to perform any Political Action which can be defined by the word. For example, an Attack can be verbal, physical, personal or even political. You can Hold a festival, or Hold someone for ransom. These actions are free to be described by the Player. Multiple Action Words can even be combined together to create more complex actions.

However, Political Actions cannot fabricate something from nothing, and neither can they abruptly destroy or alter an object, individual, civilisation or concept. All Political Actions must be possible for the character performing them to do, or order another to do. "Send: a poisoned banana into my enemy's heart!" is not something anyone can do at a whim.[^6]

Each Turn, Players submit a report to the N.O. detailing what actions they perform. This can be by e-mail, voice recording, telecommunication or Monkey Scribe. The deadline for submitting Reports is determined by the N.O.
...
Players take it in turns to roleplay actions as the Ruler of their Realm. On their turn, a Ruler will also resolve any issues that have been presented to them that Turn, such as arriving emissaries and invasions. In addition to this, a Ruler may perform Fiscal and Political Actions. These actions advance the story of your game and can be performed by the Ruler or a Subordinate.

While roleplaying the story of your game of Rulers, it is encouraged for both Players and the N.O. to act in-character as much as possible. This means doing what the character would do, based on their personality and what the character would know. However, if anyone wants to put on an accent at any point, then it must be agreed by everyone that it isn't so irritating as to warrant an impromptu flogging.
...
A Political Action can be prepared ahead of time. A Ruler can give the Action Words to an Agent with the instruction not to perform the action until a trigger they specify occurs. This Agent can be freed from this command on a player's turn, but the Action Words are discarded.

When the N.O. performs the actions of NPC Rulers and Characters, they are treated as having any Action Words they want at any given time. The N.O. has the final say on all Political Actions. It is their duty to watch over the narrative of the game and make sure that Political Actions make sense, and are not against the interest of fun for the rest of the Players.
...
14. **Draft** — A peace treaty, a new law
15. **End** — War, peace, trade routes
...
29. **Pardon** — An individual, a noble, a sinner
...
[^3]: You can still use these words in normal, non-Political-Action sentences. We're not that cruel.
[^4]: At least, not until they harness the powers of Magic. But I haven't written that, yet...
[^5]: It's best not to change too much at once. It frightens the peasantry.
